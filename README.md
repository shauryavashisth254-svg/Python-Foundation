...
3. **Break & Repeat:** 4 cycles per day.
...
- [ ] **Module 10:** File Handling & Exceptions

**Phase 2: Advanced Concepts & GUI**
- [ ] **Module 12:** Object-Oriented Programming (OOP) Basics
- [ ] **Modules 13-14:** Tkinter & GUI Building
...
5. **Control Flow Sorter (3-Variable)** - [Link to file](./week2_practice.py) ✅
6. **Hardware Security Audit (Sets & Frozensets)** - [Link to file](./security_audit.py) ✅
7. **GUI Electronics Toolkit** *(Summer Capstone Project)* ⏳
